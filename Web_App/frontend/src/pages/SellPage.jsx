    ...
    <div style={s.page}>
      ...
      <div style={s.formGroup}>
        ...
        <div
          ...
          onMouseEnter={e => { e.currentTarget.style.borderColor='#C4A96B'; e.currentTarget.style.background='#EDE4D0'; }}
          onMouseLeave={e => { e.currentTarget.style.borderColor='#E2DDD4'; e.currentTarget.style.background='#fff'; }}
        >
          {form.imagePreview ? (
            <img src={form.imagePreview} alt="preview" style={{ maxHeight: '120px', borderRadius: '8px' }} />
          ) : (
            <>
              <div style={s.uploadIcon}>📷</div>
              <div style={s.uploadText}><strong>Click to upload</strong> or drag and drop</div>
              <div style={{ ...s.uploadText, fontSize: '0.78rem', marginTop: '0.25rem' }}>PNG, JPG up to 10MB</div>
            </>
          )}
        </div>
      ...
      <div style={s.row2}>
        ...
        <div style={s.formGroup}>
          ...
          <input type="number" placeholder="2" min="1" max="20" value={form.rooms} onChange={e => set('rooms')(e.target.value)} />
        </div>
      </div>
